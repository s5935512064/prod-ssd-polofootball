...
const Privacypolicy = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>นโยบายความเป็นส่วนตัว : สนามฟุตบอลในร่มหญ้าเทียมแห่งแรกในย่านธุรกิจใจกลางเมือง  เดินทางสะดวก  เข้าออกได้หลายทางจากซอยโปโล ด้านถนนวิทยุ  หรือ ซอยปลูกจิต ถนนพระรามสี่ หญ้าเทียมนำเข้าจากประเทศเบลเยี่ยม ใช้เทคโนโลยีการผลิตและติดตั้งมาตรฐานยุโรปให้ความรู้สึกเรียบ เนียน ไม่สะดุดเท้า เปิดบริการถึงเที่ยงคืน </title>
            ...
            <div className="h-full  w-full relative flex justify-center">
                <div className="min-h-screen w-full h-full bg-white md:rounded-tr-[100px]  max-w-7xl  py-10 relative ">
                    ...
                    <section className="flex w-full min-h-screen h-full flex-col  px-6 lg:px-10 items-center">
                        <div className="max-w-5xl">

                            <h1 className="text-center text-2xl md:text-3xl font-medium mb-4">นโยบายความเป็นส่วนตัว <br></br>ของกลุ่มบริษัท สยามสินธร จำกัดและบริษัทในเครือ
                            </h1>
                            ...
                            <p className="break-words whitespace-pre-line font-light text-sm sm:text-base indent-6 text-justify mb-2">บริษัทขอสงวนสิทธิในการปรับปรุงแก้ไขรายละเอียดเกี่ยวกับนโยบายความเป็นส่วนตัวทั้งหมดหรือบางส่วน โดยไม่ต้องแจ้งให้ท่านทราบ ทั้งนี้ การแก้ไขเปลี่ยนแปลงใดๆ จะมีผลทันทีเมื่อบริษัทเผยแพร่นโยบายความเป็นส่วนตัวที่แก้ไขดังกล่าวทาง <a href="https://polofootballpark.com/" target="_blank" rel="noopener noreferrer" className="text-green-600">https://polofootballpark.com/</a> </p>
                            ...
                            <ul className="ml-5 list-outside font-light text-sm sm:text-base  mb-2">
                                ...
                                <li> <span className="w-16 table-cell">อีเมล</span><span className="table-cell text-green-600">
